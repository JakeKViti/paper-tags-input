...
## Installation
	...
	bower install --save jakekviti/paper-tags-input -f

To use my changes, you have to make sure that it is pointed to my commit in the bower.json

	"paper-tags-input": "jakekviti/paper-tags-input#1d70ae2"
